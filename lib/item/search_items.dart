    ...
    if (searchController.text != "") {
      try {
        var res = await http.post(Uri.parse(API.searchItems), body: {
          "typedKeyWord": searchController.text,
        });
        ...
        if (res.statusCode == 200) {
          ...
          if (responseBodyOfSearchItems['success'] == true) {
            for (var eachItemData
                in (responseBodyOfSearchItems['searchDataResult'] as List)) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () {
                    Get.to(
                        () => ItemDetailScreen(itemInfo: eachClothItemRecord));
                  },
                  child: Container(
                      ...
                      children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          left: 12, right: 12),
                                      child: Text(
                                        "${NumberFormat('#,##0').format(eachClothItemRecord.item_price)} THB ",
                                        maxLines: 2,
                                        overflow: TextOverflow.ellipsis,
                                        style: const TextStyle(
                                          fontSize: 18,
                                ...
                                //tags
                                Text(
                                  "Tags: \n ${eachClothItemRecord.item_tags.toString().replaceAll("[", "").replaceAll("]", "")}",
                                  maxLines: 2,
                                  overflow: TextOverflow.ellipsis,
                                  style: const TextStyle(
                                    fontSize: 12,
                        ...
                        ClipRRect(
                          ...
                          child: FadeInImage(
                            ...
                            image: NetworkImage(
                              eachClothItemRecord.item_image!,
                            ),
                            imageErrorBuilder:
